...
export function HeroSection() {
    ...
    return (
        <section
            ...
            style={{
                background:
                    'linear-gradient(135deg, rgba(32, 237, 163, 0.10) 0%, #EFF6FF 50%, rgba(254, 42, 179, 0.10) 100%)',
            }}
        >
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            ...
                            <Button
                                className="bg-[#20EDA3] hover:bg-[#1BC98A] text-black px-8 py-6"
                ...
                >
                    ...
                    >
                        ...
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/aBIhXQEu2cQ?autoplay=1"
                            title="Video"
                            frameBorder="0"
